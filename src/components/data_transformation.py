...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path, test_path):
        try:
            ...
            target_feature_name_train_df = train_df[target_column_name]

            input_feature_test_df = test_df.drop(columns=[target_column_name])
            target_feature_name_test_df = test_df[target_column_name]
            ...
            train_arr = np.c_[
                input_feature_train_array, np.array(target_feature_name_train_df)
            ]

            test_arr = np.c_[
                input_feature_test_array, np.array(target_feature_name_test_df)
            ]
